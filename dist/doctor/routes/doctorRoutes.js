      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            doctor = req.body;
            _context.next = 4;
            return _doctorServices["default"].createDoctor(doctor);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _doctorServices["default"].getAllDoctors();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            doctor = req.body;
            _context3.next = 5;
            return _doctorServices["default"].updateDoctorById(doctorId, doctor);

          case 5:
            _context3.next = 7;
            return _doctorServices["default"].getdoctorById(doctorId);
